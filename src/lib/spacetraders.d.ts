...
export interface external {
  "../models/ActivityLevel.json": "WEAK" | "GROWING" | "STRONG" | "RESTRICTED";
  "../models/Agent.json": {
  ...
  "../models/Chart.json": {
    waypointSymbol?: external["../models/WaypointSymbol.json"];
  ...
  "../models/Construction.json": {
    ...
    materials: external["../models/ConstructionMaterial.json"][];
    /** @description Whether the waypoint has been constructed. */
    isComplete: boolean;
  };
  "../models/ConstructionMaterial.json": {
    tradeSymbol: external["../models/TradeSymbol.json"];
  ...
  "../models/Contract.json": {
    ...
    terms: external["../models/ContractTerms.json"];
    /**
  ...
  "../models/ContractTerms.json": {
     ...
     */
    deadline: string;
    payment: external["../models/ContractPayment.json"];
    /** @description The cargo that needs to be delivered to fulfill the contract. */
    deliver?: external["../models/ContractDeliverGood.json"][];
  };
  ...
  "../models/Extraction.json": {
    ...
    shipSymbol: string;
    yield: external["../models/ExtractionYield.json"];
  };
  "../models/ExtractionYield.json": {
    symbol: external["../models/TradeSymbol.json"];
    /** @description The number of units extracted that were placed into the ship's cargo hold. */
    units: number;
  };
  "../models/Faction.json": {
    symbol: external["../models/FactionSymbol.json"];
  ...
  "../models/MarketTradeGood.json": {
    ...
    tradeVolume: number;
    supply: external["../models/SupplyLevel.json"];
    activity?: external["../models/ActivityLevel.json"];
  ...
  "../models/ScannedShip.json": {
    ...
    symbol: string;
    registration: external["../models/ShipRegistration.json"];
    nav: external["../models/ShipNav.json"];
  ...
  "../models/ScannedSystem.json": {
    ...
    sectorSymbol: string;
    type: external["../models/SystemType.json"];
  ...
  "../models/ScannedWaypoint.json": {
    symbol: external["../models/WaypointSymbol.json"];
    type: external["../models/WaypointType.json"];
    systemSymbol: external["../models/SystemSymbol.json"];
    /** @description Position in the universe in the x axis. */
    x: number;
    /** @description Position in the universe in the y axis. */
    y: number;
    /** @description List of waypoints that orbit this waypoint. */
    orbitals: external["../models/WaypointOrbital.json"][];
    faction?: external["../models/WaypointFaction.json"];
    /** @description The traits of the waypoint. */
    traits: external["../models/WaypointTrait.json"][];
    chart?: external["../models/Chart.json"];
  };
  "../models/Ship.json": {
    ...
    registration: external["../models/ShipRegistration.json"];
    nav: external["../models/ShipNav.json"];
    crew: external["../models/ShipCrew.json"];
    frame: external["../models/ShipFrame.json"];
    reactor: external["../models/ShipReactor.json"];
    engine: external["../models/ShipEngine.json"];
    cooldown: external["../models/Cooldown.json"];
    /** @description Modules installed in this ship. */
    modules: external["../models/ShipModule.json"][];
    /** @description Mounts installed in this ship. */
    mounts: external["../models/ShipMount.json"][];
    cargo: external["../models/ShipCargo.json"];
    fuel: external["../models/ShipFuel.json"];
  };
  "../models/ShipCargo.json": {
    ...
    inventory: external["../models/ShipCargoItem.json"][];
  };
  ...
  "../models/ShipCondition.json": number;
  ...
  "../models/ShipEngine.json": {
    ...
    description: string;
    condition?: external["../models/ShipCondition.json"];
    ...
    speed: number;
    requirements: external["../models/ShipRequirements.json"];
  };
  ...
  "../models/ShipNav.json": {
    systemSymbol: external["../models/SystemSymbol.json"];
    waypointSymbol: external["../models/WaypointSymbol.json"];
    route: external["../models/ShipNavRoute.json"];
    status: external["../models/ShipNavStatus.json"];
    flightMode: external["../models/ShipNavFlightMode.json"];
  };
  "../models/ShipNavFlightMode.json": "DRIFT" | "STEALTH" | "CRUISE" | "BURN";
  "../models/ShipNavRoute.json": {
    destination: external["../models/ShipNavRouteWaypoint.json"];
    origin: external["../models/ShipNavRouteWaypoint.json"];
    /**
     * Format: date-time
  ...
  "../models/ShipNavStatus.json": "IN_TRANSIT" | "IN_ORBIT" | "DOCKED";
  ...
  "../models/ShipRegistration.json": {
    ...
    factionSymbol: string;
    role: external["../models/ShipRole.json"];
  };
  ...
  "../models/ShipRole.json": "FABRICATOR" | "HARVESTER" | "HAULER" | "INTERCEPTOR" | "EXCAVATOR" | "TRANSPORT" | "REPAIR" | "SURVEYOR" | "COMMAND" | "CARRIER" | "PATROL" | "SATELLITE" | "EXPLORER" | "REFINERY";
  "../models/ShipType.json": "SHIP_PROBE" | "SHIP_MINING_DRONE" | "SHIP_SIPHON_DRONE" | "SHIP_INTERCEPTOR" | "SHIP_LIGHT_HAULER" | "SHIP_COMMAND_FRIGATE" | "SHIP_EXPLORER" | "SHIP_HEAVY_FREIGHTER" | "SHIP_LIGHT_SHUTTLE" | "SHIP_ORE_HOUND" | "SHIP_REFINING_FREIGHTER" | "SHIP_SURVEYOR";
  ...
  "../models/Siphon.json": {
    ...
    shipSymbol: string;
    yield: external["../models/SiphonYield.json"];
  };
  ...
  "../models/SupplyLevel.json": "SCARCE" | "LIMITED" | "MODERATE" | "HIGH" | "ABUNDANT";
  "../models/Survey.json": {
    ...
    deposits: external["../models/SurveyDeposit.json"][];
    /**
     * Format: date-time
  ...
  "../models/System.json": {
    ...
    waypoints: external["../models/SystemWaypoint.json"][];
    /** @description Factions that control this system. */
    factions: external["../models/SystemFaction.json"][];
  };
  "../models/SystemFaction.json": {
    symbol: external["../models/FactionSymbol.json"];
  };
  "../models/SystemSymbol.json": string;
  "../models/SystemType.json": "NEUTRON_STAR" | "RED_STAR" | "ORANGE_STAR" | "BLUE_STAR" | "YOUNG_STAR" | "WHITE_DWARF" | "BLACK_HOLE" | "HYPERGIANT" | "NEBULA" | "UNSTABLE";
  ...
  "../models/Waypoint.json": {
    ...
    modifiers?: external["../models/WaypointModifier.json"][];
    chart?: external["../models/Chart.json"];
...
export interface operations {
  ...
  register: {
    requestBody?: {
      content: {
        "application/json": {
          faction: external["../models/FactionSymbol.json"];
          /**
    ...
    responses: {
      ...
      201: {
        content: {
          "application/json": {
            data: {
              agent: external["../models/Agent.json"];
              contract: external["../models/Contract.json"];
              faction: external["../models/Faction.json"];
              ship: external["../models/Ship.json"];
  ...
  "get-systems": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/System.json"][];
  ...
  "get-system-waypoints": {
    parameters: {
      query?: {
        ...
        traits?: external["../models/WaypointTraitSymbol.json"] | external["../models/WaypointTraitSymbol.json"][];
      };
      path: {
        /** @description The system symbol */
        systemSymbol: string;
  ...
  "get-market": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/Market.json"];
          };
        };
      };
    };
  ...
  "get-shipyard": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/Shipyard.json"];
          };
        };
      };
    };
  ...
  "get-jump-gate": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/JumpGate.json"];
          };
        };
      };
    };
  ...
  "get-construction": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/Construction.json"];
          };
        };
      };
    };
    ...
    responses: {
      ...
      201: {
        content: {
          "application/json": {
            data: {
              construction: external["../models/Construction.json"];
              cargo: external["../models/ShipCargo.json"];
            };
          };
        };
  ...
  "get-factions": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/Faction.json"][];
            meta: external["../models/Meta.json"];
          };
        };
      };
  ...
  "get-my-agent": {
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/Agent.json"];
          };
        };
      };
    };
  ...
  "get-contracts": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/Contract.json"][];
            meta: external["../models/Meta.json"];
          };
        };
      };
  ...
  "get-my-ships": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/Ship.json"][];
            meta: external["../models/Meta.json"];
          };
        };
      };
  ...
  "purchase-ship": {
    requestBody?: {
      content: {
        "application/json": {
          shipType: external["../models/ShipType.json"];
        ...
        content: {
          "application/json": {
            data: {
              agent: external["../models/Agent.json"];
              ship: external["../models/Ship.json"];
              transaction: external["../models/ShipyardTransaction.json"];
            };
          };
        };
      };
  ...
  "get-my-ship-cargo": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/ShipCargo.json"];
          };
        };
      };
    };
  ...
  "get-ship-cooldown": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/Cooldown.json"];
          };
        };
      };
        ...
        content: {
          "application/json": {
            data: {
              ...
              surveys: external["../models/Survey.json"][];
            };
          };
        };
      };
  ...
  "extract-resources": {
    ...
    requestBody?: {
      content: {
        "application/json": {
          /** @deprecated */
          survey?: external["../models/Survey.json"];
        };
      };
    };
    responses: {
      ...
      201: {
        content: {
          "application/json": {
            data: {
              cooldown: external["../models/Cooldown.json"];
              extraction: external["../models/Extraction.json"];
              cargo: external["../models/ShipCargo.json"];
            };
          };
        };
      ...
      201: {
        content: {
          "application/json": {
            data: {
              cooldown: external["../models/Cooldown.json"];
              siphon: external["../models/Siphon.json"];
              cargo: external["../models/ShipCargo.json"];
            };
          };
        };
  ...
  "extract-resources-with-survey": {
    ...
    requestBody?: {
      content: {
        "application/json": external["../models/Survey.json"];
      };
    };
    responses: {
      /** @description Extracted successfully. */
        ...
        content: {
          "application/json": {
            data: {
              nav: external["../models/ShipNav.json"];
              cooldown: external["../models/Cooldown.json"];
              transaction: external["../models/MarketTransaction.json"];
              agent: external["../models/Agent.json"];
            };
          };
        };
  ...
  "get-ship-nav": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/ShipNav.json"];
          };
        };
      };
    };
        ...
        content: {
          "application/json": {
            data: {
              ...
              systems: external["../models/ScannedSystem.json"][];
            };
          };
        };
      };
        ...
        content: {
          "application/json": {
            data: {
              ...
              waypoints: external["../models/ScannedWaypoint.json"][];
            };
          };
        };
      };
        ...
        content: {
          "application/json": {
            data: {
              ...
              ships: external["../models/ScannedShip.json"][];
            };
          };
        };
      };
  ...
  "get-mounts": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data: external["../models/ShipMount.json"][];
          };
        };
      };
    };
        ...
        content: {
          "application/json": {
            data: {
              ...
              mounts: external["../models/ShipMount.json"][];
              cargo: external["../models/ShipCargo.json"];
              transaction: external["../models/ShipModificationTransaction.json"];
            };
          };
        };
      };
